...
int main(int argc, char** argv) {
    ...
    int* d_hits = (int*) nvshmem_malloc(sizeof(int)); // Allocate `d_hits` as a symmetric data object
    ...
    *hits = 0;
    ...
    nvshmem_int_sum_reduce(NVSHMEM_TEAM_WORLD, d_hits_total, d_hits, 1);//Aggregation is done here finally :)
